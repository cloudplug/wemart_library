...
import cn.wemart.adapter.DialogListViewAdapter;
...
public class PickDialog extends Dialog {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		LinearLayout layout = (LinearLayout) inflater.inflate(
				R.layout.wemart_blend_dialog_preview_layout, null);

		TextView titleTextview = (TextView) layout
				.findViewById(R.id.wemart_blend_dialog_title);
		titleTextview.setText(title);
		TextView cancleTextView = (TextView) layout
				.findViewById(R.id.wemart_blend_dialog_cancle_btn);
		cancleTextView.setText("取消");
		blend_dialog_preview = (LinearLayout) layout
				.findViewById(R.id.wemart_blend_dialog_preview);
		blend_dialog_nextview = (ListView) layout
				.findViewById(R.id.wemart_blend_dialog_nextview);
	...
	public void initListViewData(ArrayList<String> lists) {
		items = lists;
		blend_dialog_preview.setVisibility(View.GONE);
		blend_dialog_nextview.setVisibility(View.VISIBLE);
		adapter = new DialogListViewAdapter(context, lists);
